  ...
  <div id="publish_second" ref="publish_second">
    ...
    <div class="content">
      <div class="item">
        ...
        <div class="input">
          <input type="number" placeholder="请输入市场价" v-model="form.market_price" />
        </div>
      </div>
      <div class="item">
        <div class="title">起拍价</div>
        <div class="input">
          <input type="number" placeholder="请输入起拍价" v-model="form.start_price" />
        </div>
      </div>
      <div class="item">
      ...
      <div class="item">
        ...
        <div class="input">
          <input type="number" placeholder="请输入价格" v-model="form.mini_markup" />
        </div>
      </div>
      <div class="item">
        <div class="title">保留价</div>
        <div class="input">
          <input type="number" placeholder="请输入保留价" v-model="form.mini_deal" />
        </div>
      </div>
      <div class="item">
      ...
      <div class="item-special">
        ...
        <div class="input" v-show="form.prepayment_mode == '1'">
          <input type="number" placeholder="请输入比例" v-model="form.advance_proportion" />
        </div>
        <div class="input" v-show="form.prepayment_mode == '2'">
          <input type="number" placeholder="请输入金额" v-model="form.advance_money" />
        </div>
      </div>
      <div class="item-special">
        <div class="title">
        ...
        <div class="input" v-show="form.em_mode == '1'">
          <input type="number" placeholder="请输入比例" v-model="form.em_proportion" />
        </div>
        <div class="input" v-show="form.em_mode == '2'">
          <input type="number" placeholder="请输入金额" v-model="form.endorsement" />
        </div>
      </div>
      <div class="item">
