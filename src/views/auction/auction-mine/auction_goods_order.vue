<template>
  <div id="goodsinfo" :class="[this.fun.getPhoneEnv() == 3 ? 'pcStyle' : '']">
    ...
    <template v-if="!isShowDistributionStation && this.$route.params.tag != 'POrder' && !is_open_package_deliver">
      ...
      <div v-if="!store_id && !show_address" class="addr" @click="showAddress">
        <div class="icon">
          <i class="fa fa-map-marker"></i>
          <p v-show="realname">
            收件人:{{ realname }} {{ mobile }}
...
"
    ...
    <div class="goods-detail">
      ...
      <div v-for="(item, index) in order_data" :key="index">
        ...
        <div class="rent-info">
          <!-- <ul>
              <li>租金</li>
              <li>{{$i18n.t('money')}}270.00</li>
          </ul>
          <ul>
              <li>会员折扣</li>
              <li>-{{$i18n.t('money')}}30.00</li>
          </ul>
          <ul>
              <li>运费</li>
              <li>{{$i18n.t('money')}}6.00</li>
          </ul>  -->
        </div>
        <!-- 租赁结束 -->
    ...
    <div class="tbs">
      ...
      <!-- <div class="price list">
        <div class="left ">{{ dispatchInfo.name }}</div>
        <div class="right">
          <div class="right">
            <font color="#E84E40">{{$i18n.t('money')}}{{ dispatch_price }}</font>
          </div>
        </div>
      </div>
       <div class="price list">
        <div class="left ">{{ deductionInfo.name }}</div>
        <div class="right">
          <div class="right">
