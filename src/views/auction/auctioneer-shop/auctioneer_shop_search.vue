<template>
  <div id="auctioneer_shop_search" ref="auctioneer_shop_search">
    <c-title :hide="false" text="全部拍品"></c-title>
    <div class="content">
      <div class="input">
        <i class="iconfont icon-sousuo" @click="getSearch()"></i>
        <input type="text" placeholder="搜索拍卖商品" v-model="keyword" @keypress="enterSearch">
      </div>
      <div class="good-list">
...
<script>
import auctioneer_shop_search_controller from "./auctioneer_shop_search_controller";

export default auctioneer_shop_search_controller;
</script>

<style lang="scss" rel="stylesheet/scss" scoped>
  #auctioneer_shop_search {
    padding-top: 40px;
