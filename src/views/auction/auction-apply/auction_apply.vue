<template>
  <div id="auction_apply" ref="auction_apply">
    ...
    <div class="content">
      ...
      <div class="upload">
        <div class="list">
          <div class="left"><span>上传身份证正面</span><span class="xi">*</span></div>
          <div class="image"
          :style="{backgroundImage: 'url(' + (positive.length>0 ? positive : require('../../../assets/images/bg_idcard_up.png')) + ')'}">
            <div class="icon">
        ...
        <div class="list">
          <div class="left"><span>上传身份证背面</span><span class="xi">*</span></div>
          <div class="image"
