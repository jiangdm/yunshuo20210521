  ...
  <div id="coupon_share_code">
    ...
    <div class="box">
      ...
      <div class="centenBox">
        ...
        <span
          v-if="is_belongs_to_coupon.coupon_method == 1"
          style="margin-top: 2rem; font-size: 1.18rem; color: #fff; line-height: 1.09rem;"
        >满{{is_belongs_to_coupon.enough}}可用</span>
        <span
          v-if="is_belongs_to_coupon.coupon_method == 2"
          style="margin-top: 2rem; font-size: 1.18rem; color: #fff; line-height: 1.09rem;"
        >满{{ is_belongs_to_coupon.enough }}立享</span>
        <div class="timeMin">
    ...
    <van-popup
      v-model="posterShow"
      round
      class="newcomerAward_popup"
      :style="{ height: '25.44rem' ,backgroundColor:'transparent'}"
    >
...
.centenBox {
  ...
  width: 18.13rem;
  height: 24.66rem;
  background-image: url('https://www.yunzmall.com/min_img/couponssharebg@2x.png');
