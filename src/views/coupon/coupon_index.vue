<template>
  <div id="coupon_index">
                ...
                <div class="left">
                  ...
                  >
                    <template v-if="item.belongs_to_coupon.coupon_method == 1">
                      <span class="textOne" :style="{'fontSize':(item.belongs_to_coupon.deduct.length > 5?'0.7rem':'')}">
                        {{$i18n.t('money')}}{{ item.belongs_to_coupon.deduct }}
                      </span>
                      <div class="line"></div>
            ...
            <van-swipe-cell>
              <div class="shopCouponNew">
                <div class="left">
                  <div
                    class="postLeft"
                    :style="{backgroundImage:`url(https://www.yunzmall.com/min_img/couponsbg_7.png)`}"
                    >
                    <template v-if="item.belongs_to_coupon.coupon_method == 1">
                      <span class="textOne" :style="{'fontSize':(item.belongs_to_coupon.deduct.length > 5?'0.7rem':'')}">
                        {{$i18n.t('money')}}{{ item.belongs_to_coupon.deduct }}
    ...
    <div class="posbtn" @click="toStore">
      <img src="https://www.yunzmall.com/min_img/coupons_centerbg@2x.png" alt="">
      <div>领券中心</div>
    </div>
    <van-dialog
