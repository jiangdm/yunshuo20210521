  ...
  <div id="login">
      ...
      <div v-show="loading">
        <div id="login_box" v-if="appShow">
          ...
          <template v-if="mobile_login_code == 1">
            ...
            <div class="login-tips" style="margin-top: 8px;" >注册即同意 <span class="blue" @click.stop="toRegisterText">《{{protocol_title || '平台用户协议'}}》</span></div>
          </template>
    ...
    <div class="login_type2" v-if="login_type==2">
      <div style="position: relative;">
        ...
        <img
          style="width: 20%; height: 40px; position: absolute; display: block; left: 74%; top: 11rem; z-index: 999;"
          :src="imgcode"
          @click="getimgdata"
          v-if="imgcode && pc_bind_mobile == 1"
        />
      </div>
