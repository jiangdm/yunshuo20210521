<template>
  <div id="team_rewards_record" v-if="member.nickname">
    <c-title :hide="false" :text="member.plugin_name">
    </c-title>
    ...
    <div class="list_box">
      <ul class="box" v-for="(item,index) in recordsList" :key="index">
        ...
        <li>
          <span class="time">团队业绩总额：{{item.performance_total}}</span>
          <span class="state">奖励比例：{{item.ratio}}%</span>
        </li>
        <li>
          <span class="time">下级团队奖励金额：{{item.lower_performance_total}}</span>
