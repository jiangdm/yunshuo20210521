<template>
    <div id="qr_coupon" v-if="coupon.name&&status">
        ...
        <div class="content">
            <div class="info">
                ...
                <div class="money" v-if="coupon.deduct"><span>{{$i18n.t('money')}}</span><span>{{coupon.deduct}}</span></div>
            ...
            <div class="goods">
                ...
                <div class="good">
                    ...
                    <div class="right">
                        ...
                        <div class="cash">{{$i18n.t('money')}}{{goods.price}}</div>
                    </div>
                </div>
            </div>
        </div>
