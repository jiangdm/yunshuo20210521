...
">
        ...
        <div class="user_protocol">
            <van-checkbox v-model="checked">阅读并同意<span class="us_color" @click.stop="openProtocol">《用户协议》</span></van-checkbox>
        </div>
            ...
            <div class="classification">
                ...
                <div class="classification_list">
                    <ul v-for="(item,i) in catelist" :key='i'>
                        <li @click="selectCateId(item.id,item.name)">{{item.name}}</li>
                    </ul>
                </div>
            </div>
        </van-popup>
