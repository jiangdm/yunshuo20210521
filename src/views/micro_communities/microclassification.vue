          ...
          <div v-if="load" :key="index">
            ...
            <span v-show="selected == 1 + index + ''">
              <div class="video_list" v-if="item && item.length > 0">
                ...
                <!-- =======================废弃  v-if=='false'; ============================= -->
                <ul v-if="false">
                  <li v-for="(childitem, childindex) in item" :key="childindex" @click="jumpDetails(childitem.has_many_image[0].stick_id)">
                    <div class="top">
                      <img :src="childitem.has_many_image[0].url" alt="" />
                    </div>
                    <div class="bottom">
                      ...
                      <div class="content">
                        <div class="headmessage">
                          <div class="left">
                            <img :src="childitem.has_one_stick_user.avatar" alt="" />
                          </div>
