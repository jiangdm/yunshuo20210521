        ...
        <div id="content">
          ...
          <ul class="login_info">
            <li v-if="imgcode" class="codeBox info-box">
              ...
              <img
                style="width: 20%; height: 40px; position: absolute; display: block; right: 0; bottom: 0; z-index: 999;"
                :src="imgcode"
                @click="getimgdata"
                v-if="imgcode"
              />
            ...
            <li class="code info-box" v-if="is_enable == 0">
              ...
              <van-field
                ...
                :border="false"
              />
              <van-button plain type="primary" size="small" :disabled="btnTag" @click.native="verificationCode">{{
                btnText
                }}
              </van-button>
            </li>
          ...
          <div class="diyform">
            <template v-for="(item,index) in diydata">
              <template v-if="item.type == 'diyinput'">
                ...
                <van-cell-group :border="false" class="commont-style" :key="index">
              ...
              <template v-if="item.type == 'diytextarea'">
                ...
                <van-cell-group :title="item.data.tp_name" :key="index" :border="false" style="text-align: left;">
                  <van-field
                    v-model="item.value"
                    rows="4"
                    autosize
              ...
              <template v-if="item.type == 'diycheckbox'">
                <van-checkbox-group v-model="item.value" :key="index">
                  <van-cell-group :title="item.data.tp_name" :border="false" class="checkout-box">
                    <van-cell
                      :border="false"
                      title-class="checkbox-left"
              ...
              <template v-if="item.type == 'diypwd'">
                <van-cell-group :border="false" class="use-name pwd-inp" :key="index">
              ...
              <template v-if="item.type == 'diyusername'">
                <van-cell-group :border="false" class="use-name" :key="index">
                  <van-cell :border="false" center>
                    <van-field style="height: 30px;" :class="[item.value ? 'vant-sure-class': 'vant-no-sure-class']"
                               v-model.trim="item.value" v-if="item.data.tp_must == 1"
              ...
              <template v-if="item.type == 'diyselect'">
                <van-cell-group :border="false" class="checkout-box" :key="index">
                  <van-cell is-link :border="false">
                    <select v-model="item.value" class="select-down">
              ...
              <template v-if="item.type == 'diyradio'">
                <van-radio-group v-model="item.value" :key="index">
                  <van-cell-group :title="item.data.tp_name" :border="false" class="checkout-box">
                    ...
                    >
                      <template #right-icon>
                        <van-radio :name="ritem.toString()" checked-color="#4cd864">
                          <template #icon="props">
                            <i class="iconfont check-icon " :class="props.checked ? 'icon-record_go' : ''"></i>
                          </template>
                        </van-radio>
                      </template>
                    </van-cell>
              ...
              <template v-if="item.type == 'diycity'">
                <van-cell-group :border="false" class="checkout-box" :key="index">
                  <van-cell :border="false" is-link @click.stop="showCity = true">
                    <input
                      style="width: 100%; border: none; font-size: 16px;"
                      type="text"
              ...
              <template v-if="item.type == 'diydate'">
                <van-cell-group :border="false" class="checkout-box" :key="index">
                  <van-cell :border="false" @click.native="openPicker(item.name)" title-class="time-left">
              ...
              <template v-if="item.type == 'diyimg'">
                <van-cell-group :title="item.data.tp_name" :key="index">
                  <div
                    class="clearfloat"
          ...
          <div v-if="fromBase_address == '1'" style="margin-top: 10px;" class="address_nontext">
            ...
            <div style="padding: 0 0.5rem;">
              ...
              <van-cell :border="false" center title-class="area-left"
                        style="border: 1px solid #e3e3e3; padding: 10px 0;">
                <van-field
                  style="padding: 10px;"
                  class="address-detailed"
          ...
          <div style="padding: 0 0.5rem;" class="persona-data">
            <van-cell
              :border="false"
              center
              title-class="persona-left"
              v-if="fromBase_birthday == '1'"
              is-link
              @click.native="openPickers"
            >
          ...
          <div style="margin-top: 10px;" v-if="customDatas.length > 0">
            ...
            <div style="padding: 0 0.5rem;" class="persona-data">
              <van-cell
                ...
                center
                title-class="persona-left"
                value-class="right-info"
                v-for="(cItem, i) in customDatas"
                :key="i"
                is-link
              >
          ...
          <div class="persona-data other-info">
            <van-cell-group :title="custom_title + '信息'" v-if="is_custom" :border="false">
              <van-cell :border="false" center title-class="other-info">
                ...
                <van-field
                  v-model.trim="form.custom_value"
                  type="text"
                  clearable
                  placeholder=""
                  center
          ...
          <template>
            <div class="agreement" v-if="agreementStatus || PlatformAgreement">
              ...
              <span slot="right" style="font-size: 0.75rem; color: #ff2c29; cursor: pointer;" @click="goAgreement" v-show="agreementStatus">
                《{{protocol_title || '会员注册协议'}}》</span
              >
...
<style lang="scss" rel="stylesheet/scss" scoped>
  #register {
    ...
    .topImg {
      width: 100%;
      height: 13rem;
      // background-image: url('../../assets/images/logindefault_bg@2x.png');
