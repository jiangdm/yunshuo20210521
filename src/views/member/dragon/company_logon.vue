    ...
    <div class="content">
      ...
      <div class="four">
        ...
        <div class="form_four">
          ...
          <div class="list">
            <span>{{formData.registrant==1?'法人':'授权人'}}身份证正面</span>
            <div class="image-two"
                 :style="{backgroundImage: 'url(' + (formData.legalFrontURL.length>0 ?  formData.legalFrontURL : require('../../../assets/images/bg_idcard_up.png')) + ')'}">
              <div class="icon">
          ...
          <div class="list">
            <span>{{formData.registrant==1?'法人':'授权人'}}身份证反面</span>
            <div class="image-three"
                 :style="{backgroundImage: 'url(' + (formData.legalBackURL.length>0 ?  formData.legalBackURL : require('../../../assets/images/bg_idcard_down.png')) + ')'}">
              <div class="icon">
