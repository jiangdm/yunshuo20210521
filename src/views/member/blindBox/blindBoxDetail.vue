            ...
            <div class="contactWrapper themeDiyBackground">
              ...
              <div class="btnPhone">
                <a :href="`tel:${activity.cservice_phone}`">
                  <img src="https://www.yunzmall.com/min_img/blindBoxContact.png" alt="" />
                </a>
              </div>
            </div>
            <div class="close">
    ...
    <van-overlay :show="seePrizeShow"  @click="onceMore">
      <div style="display: flex; align-items: center; justify-content: center; height: 100%; perspective: 25.313rem;">
        <div class="popupWrapper seePrizeWrapper"  v-if="seePrizeShow" @click.stop  :class="{ active: seePrizeAnimation }">
          <!-- <img class="imgs" src="https://www.yunzmall.com/min_img/blindBoxLuck.png" alt="" /> -->
...
.head {
  ...
  &.headMr {
    height: 8.75rem;
    background-image: url("https://www.yunzmall.com/min_img/blindHead.png");
...
.contenBox {
  ...
  .blindBox {
    width: 16.875rem;
    height: 16.875rem;
    background-image: url('https://www.yunzmall.com/min_img/blindBoxJT.png');
    background-size: 100% 100%;
  ...
  .blindBoxGif {
    width: 16.875rem;
    height: 16.875rem;
    background-image: url("https://www.yunzmall.com/min_img/blindBoxGif.gif");
    background-size: 100% 100%;
    background-repeat: no-repeat;
    margin: 0 auto;
    margin-top: 1.562rem;
  ...
  .blindBoxTap {
    width: 12rem;
    height: 3.125rem;
    background-image: url("https://www.yunzmall.com/min_img/blindBtn.png");
    background-size: 100% 100%;
...
.blindBoxInfoWrapper {
  width: 13.031rem;
  height: 20.313rem;
  background: url(https://www.yunzmall.com/min_img/blindToast2.png);
  background-size: 100% 100%;
...
.seePrizeWrapper {
  width: 18.125rem;
  height: 26.094rem;
  background: url(https://www.yunzmall.com/min_img/blindBoxSee.png);
  background-size: 100% 100%;
