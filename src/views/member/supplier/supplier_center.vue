<template>
  <div id="supplier-center">
         ...
         v-if="bannerStatus == 1">
          ...
          >
            <a :href="slide.url" style="display: block;">
              <img width="100%" style="height: 11.5rem;" :src="slide" />
            </a>
          </van-swipe-item>
        </van-swipe>
        <div class="addPosition">
          ...
          <div class="user-info">
            ...
            <ul>
              ...
              <li><span>累计{{income_name_text}}（元）</span></li>
            </ul>
          </div>
        </div>
    </div>
    <div class="withdraw">
      <ul>
        <li>可{{this.fun.initWithdrawal()}}金额</li>
        <li>
          {{$i18n.t('money')}}<i>{{ cost_money }}</i>
        </li>
      </ul>
    ...
    <div class="store-box">
      ...
      <div class="manage-list">
        <ul @click="goToInfo('1')">
          <div class="img">
            <img src="../../../assets/images/supplier-info.png" />
          </div>
          <li><span>信息管理</span></li>
        </ul>
        <ul @click="goToInfo('2')">
          <div class="img">
            <img src="../../../assets/images/supplier-goods.png" />
          </div>
          <li><span>商品管理</span></li>
        </ul>
        <ul @click="goToInfo('3')">
          <div class="img">
            <img src="../../../assets/images/supplier-order.png" />
          </div>
          <li><span>订单管理</span></li>
        </ul>
        <ul @click="goToInfo('4')">
          <div class="img">
            <img src="../../../assets/images/supplier-withdraw.png" />
          </div>
          <li><span>{{this.fun.initWithdrawal()}}记录</span></li>
        </ul>
        <ul @click="goToInfo('6')"
            v-if="insuclShow">
          <div class="img">
            <img src="https://www.yunzmall.com/min_img/supplier-policy.png" />
          </div>
