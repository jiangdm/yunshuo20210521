  ...
  <div class="page">
    ...
    <div class="items" v-if="listData.length>0">
      <div class="item" v-for="(item,key) in listData" :key="key">
        ...
        <div class="btn" @click="gotoStarMusicGoodsDetails(item.goods_id)">去参团 <i
          class="iconfont icon-member_right"></i></div>
      </div>
    </div>
    ...
    <div class="float">
      <div class="btn" @click="gotoStarMusicOpenGroup">
        <img src="https://www.yunzmall.com/min_img/star_music_open_group.png" alt="">
      </div>
      <div class="btn" @click="gotoStarMusicMy">
        <img src="https://www.yunzmall.com/min_img/star_music_my.png" alt="">
      </div>
    </div>
