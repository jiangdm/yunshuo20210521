<template>
  <div class="page">
    <z-title title="开团"></z-title>

    <div class="items">
      <div class="item" :class="{'active':sid==item.activity_id}" v-for="(item,key) in listData" :key="key"
           @click="setSid(item)">
        <div class="face">
    ...
    <div class="float">
      <div class="btn" @click="gotoStarMusicIndex">
        <img src="https://www.yunzmall.com/min_img/star_music_index.png" alt="">
      </div>
