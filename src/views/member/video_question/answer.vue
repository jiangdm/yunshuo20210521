...
"
    ...
    <van-popup v-model="pass" round :style="{ width: '18.75rem' }" closeable close-icon="cross">
      <div class="pass" v-if="is_qualified == 1">
        <div class="imgbox" :style="{ backgroundImage: 'url(https://www.yunzmall.com/min_img/jb@3x.png)' }"></div>
      ...
      <div class="pass" v-if="is_qualified == 0">
        <div class="imgbox" :style="{ backgroundImage: 'url(https://www.yunzmall.com/min_img/bdb@3x.png)' }"></div>
...
#answer {
  ...
  .pass {
    ...
    .imgbox {
      width: 11.13rem;
      height: 9.28rem;
      // background-image: url('https://www.yunzmall.com/min_img/jb@3x.png');
      background-size: 100%;
    }
