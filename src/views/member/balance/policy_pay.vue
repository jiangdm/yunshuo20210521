  ...
  <div id="balance_recharge">
    ...
    <div class="pay-box">
      ...
      <div class="pay-money">
        ...
        <div class="mid"><span class="s">{{$i18n.t('money')}}</span> <span>{{ money }}</span> </div>
...
<script>
import policy_payController from "./policy_payController";
export default policy_payController;
</script>
