    ...
    <section id="release-goods">
      <div class="left">
        <div class="release-a" style="display: flex;">
          <img
            src="https://www.yunzmall.com/min_img/supplier-protect.png"
            alt
            style="width: 30px;"
          />
        </div>
      ...
      <div class="right">
        <van-button type="danger" size="small" round @click="goToAddbalance"
        >添加保单
        </van-button
        >
      </div>
    ...
    <section id="goods-list">
      <div class="goods-list" v-for="(item, index) in data" :key="item">
        ...
        <div class="goods-list-button">
          ...
          <div class="status" v-if="!item.is_pay&&pay_status=='1'" @click.stop="gotoPay(item.id,item.supplier_id)">未支付
          </div>
