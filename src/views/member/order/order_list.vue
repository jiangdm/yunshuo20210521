<template>
  <div id="payment">
    ...
    <!--撑开标题40px、搜索30px和tab50px-->
    <div :style="{height: !amout && orderType == 'shop' ? '120px':'90px'}"></div>

    <div class="search" :style="{top: amout && orderType == 'shop' ? '10px':'40px',height: orderType == 'shop' ? '80px': '50px'}" :class="[fun.getPhoneEnv() == 3 ? 'pcStyle' : '']">
      <div class="search-box" v-if="orderType == 'shop'">
