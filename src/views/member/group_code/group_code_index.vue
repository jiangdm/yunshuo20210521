<template>
  <div class="page">
    <!-- <z-title title="群活码" fontWeight="normal" :isFixed="true" bgColor="#33d39d" fontColor="#fff"></z-title> -->
    <div class="header">
      ...
      <div class="brand">
        <van-swipe class="my-swipe"
          ...
          <van-swipe-item v-for="(item,key) in bannerList"
                          :key="key">
    ...
    <div class="ranking">
      <div class="ranking_head">
        ...
        <span class="ranking_more"
              @click="gotoRanking">更多</span>
        <icon class="iconfont icon-advertise-next"></icon>
      </div>
      <div class="ranking_content">

        <div class="ranking_item"
             v-for="(item,key) in rankingList" :key="key"
    ...
    <div class="recommend">
      <div class="recommend_head">
        ...
        <c-list-item :listData="recommendList"
                     :shop_log="shop_log"></c-list-item>
    </div>
...
<style lang="scss" rel="stylesheet/scss" scoped>
  ...
  .header {
    ...
    .header_content {
      ...
      height: 10rem;
      background-image:
        linear-gradient(150deg, #33d39d 1%, #59d4ab 100%),
        linear-gradient(#ea803f, #ea803f);
