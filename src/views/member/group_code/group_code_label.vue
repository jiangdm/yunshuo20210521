<template>
  <div class="page">
    <z-title :title="label_title"></z-title>
    <div class="wrapper">
      <div class="image">
      ...
      <div class="group">
        <div class="image">
          <img v-if="groupCodeInfoObj.member_id"
            ...
            <div v-else
              ...
              <div class="header">
                <div class="userInfo">
                  <div class="image">
                    <img class="img"
                         v-if="groupCodeInfo.member_id"
                         :src="groupCodeInfo.has_one_member.avatar_image"
                         alt="图片无效" />
                    <img class="img"
                         v-else
                         :src="shop_log"
                  ...
                  <div class="title">{{groupCodeInfo.group_code.code_name}}</div>
                </div>
                <div class="desc">
                  {{groupCodeInfo.group_code.code_guide}}
                </div>
              </div>
              <div class="footer">
