  ...
  methods: {
    ...
    share(data) {
      ...
      wx.ready(function() {
        ...
        _title = that.fun.isTextEmpty(that.activity_info.share_title) ? "标题" : that.activity_info.share_title;
        _imgUrl = that.fun.isTextEmpty(that.activity_info.share_thumb) ? "" : that.activity_info.share_thumb;
        _desc = that.fun.isTextEmpty(that.activity_info.share_content) ? "描述" : that.activity_info.share_content;
