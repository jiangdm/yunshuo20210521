        ...
        <template>
            <div v-for="(item,i) in order_data" id="isSubtotal" :key='i'>
                ...
                <div class="integral" v-show="deduction" v-for="(d,i) in deduction" :key='i'>
                    ...
                    <van-switch :class="{rt:$store.state.service.lang=='ch',lf:!$store.state.service.lang=='wei'}" v-model="d.checked" @change="discountHandle(item,d)" size="30px" active-color="#f15353" inactive-color="#fff" />
