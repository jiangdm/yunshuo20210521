<template>
  <div id="info">
    ...
    <van-cell-group class="surepwd">
      <van-cell :border="false" @click.native="showNewKeyboard">
        <van-field
          v-model="newPwd"
          maxlength="6"
          placeholder="请输入新密码"
        ...
        <template slot="right-icon">
          <i
            ...
            @click.stop="passwordClick()"
            v-if="!visible"
            style="color: #333;"
          ></i>
          <i class="iconfont icon-onlineCar_g eyes" @click.stop="passwordClick()" v-if="visible"></i>
        </template>
      </van-cell>
    </van-cell-group>
