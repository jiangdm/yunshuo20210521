  ...
  <div id="info">
    ...
    <van-cell-group title="基本信息">
      <van-cell :border="false">
        <van-field v-model="info_form.realname" label="姓名：" maxlength="10" clearable placeholder="请输入您的姓名" />
      </van-cell>
    ...
    <van-cell-group title="其他信息" v-if="isForm">
    ...
    <van-cell-group title="支付密码" v-if="isBalancePwd">
      <van-cell is-link class="customflex" :border="false" @click.native="editBalancePwd">
        <van-field slot="title" label="余额支付密码" type="text" readonly clearable placeholder="" />
      </van-cell>
    </van-cell-group>
