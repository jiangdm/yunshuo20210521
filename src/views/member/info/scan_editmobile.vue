      ...
      <div class="box1">
        <div id="content">
          ...
          <div class="agreement">
            ...
            <span slot="right" style="font-size: 16px; text-decoration: underline;" @click="agreement_show = true"
              >注册协议</span
            >
          </div>
          <!-- <div class="btn">
        ...
        <div class="diyform">
          <template v-for="(item, index) in diydata">
            <template v-if="item.type == 'diyinput'">
              <van-cell-group :border="false" class="one-line" :key="index">
            ...
            <template v-if="item.type == 'diycheckbox'">
              <van-checkbox-group v-model="item.value" checked-color="#4cd864" class="select" :key="index">
            ...
            <template v-if="item.type == 'diyselect'">
              <van-cell-group :border="false" class="down-pull" :key="index">
            ...
            <template v-if="item.type == 'diyradio'">
              <van-radio-group v-model="item.value" class="select" :key="index">
            ...
            <template v-if="item.type == 'diydate'">
              <van-cell-group :border="false" class="data-text down-pull" :key="index">
                <van-cell
                  title-style="text-align:left"
                  center
                  :border="false"
    ...
    <van-popup v-model="showChangeID" class="changeId_popup" :close-on-click-overlay="false" round>
      <div class="changeId_main">
        ...
        <p class="changeId_warnText">
          ...
          }}；绑定后所有数据记录以变更后会员ID{{ changidInfo.change_uid }}为准，<em style="color: #d53125;"
