<template>
  <div id="order-list">
    ...
    <div class="fixed-box fixed-box_my" :class="[fun.getPhoneEnv() == 3 ? 'pcStyle' : '']"
         v-if="menu_group && menu_group.enable" @click="toPickCardMy">
      <img src="https://www.yunzmall.com/min_img/pick_up_card_my.png" alt="">
    </div>
  </div>
</template>
