...
export default {
  ...
  methods: {
    ...
    getOrderList(index, str) {
      if (index == 0) {
        this.action = "plugin.picking-card.frontend.PickingOrder.index";
      } else if (index == 1) {
        this.action = "plugin.picking-card.frontend.PickingOrder.waitSend";
      } else if (index == 2) {
        this.action = "plugin.picking-card.frontend.PickingOrder.waitReceive";
      } else if (index == 3) {
        this.action = "plugin.picking-card.frontend.PickingOrder.completed";
      } else if (index == 4) {
        this.action = "plugin.picking-card.frontend.PickingOrder.refund";
      }
    ...
    toPickCard() {
      this.$router.push(this.fun.getUrl("pickUpCardIndex"));
    },
    toPickCardMy() {
