<template>
  <div class="page">
    <c-title title="会员申请"></c-title>
    <div class="headerTag">
      <div
        class="headerTagItem"
        v-for="item in applyLevelList"
        :key="item.id"
        :class="[headerTagIndex == item.id ? 'active' : '']"
        @click="setHeaderTagIndex(item.id)"
      >
        <span>{{ item.name }}</span>
      </div>
      <!--
    ...
    <div class="wrapper" v-if="!conditionFlag">
      ...
      <div id="member">
        ...
        <div class="diyform" v-if="status === 0">
          <template v-for="(item, key) in diydata">
            ...
            <template v-if="item.type == 'diytextarea'">
              <div
                :key="key"
                style="display: flex; border-bottom: 0.031rem solid #dee2ee; margin-left: 1rem; margin-right: 1.4rem; padding-top: 0.5rem;"
              >
              ...
              <div :key="key" style="border-bottom: 0.031rem solid #dee2ee; margin-left: 1rem; margin-right: 1rem;">
                ...
                <van-checkbox-group v-model="item.value">
                  <van-cell-group :border="false">
                    <van-cell
                      :key="ritem"
                      v-for="(ritem, index) in item.data.tp_text"
                      :title="ritem"
                      clickable
                      @click="toggle(index)"
                    >
            ...
            <template v-if="item.type == 'diyimg'">
              <van-cell-group
                :key="key"
                style="padding-left: 0; margin-left: 1rem; margin-right: 1rem;"
                class="blcok"
                :border="false"
              >
                <div style="margin-top: 0.8rem;">
                ...
                <div
                  class="clearfloat"
                  style="width: 100%; text-align: left; padding: 1rem; padding-left: 0; padding-top: 0.4rem;"
                >
                  <template v-if="item.data.tp_max > 1">
                    ...
                    <div @click="chooseUpload(item.name)">
                      ...
                      >
                        <div
                          style="padding-left: 1rem; padding-top: 1rem; margin-left: 0.2rem; width: 5rem; height: 5rem; border: 1px dashed #c0ccda;"
                        >
                          <img
                  ...
                  <template v-if="item.data.tp_max == 1">
                    <template v-for="(val, index) in item[item.name + 'Value2']">
                      <div
                        class="photobox"
                        style="float: left; width: 20.031rem; height: 10.625rem; margin-left: 1rem; margin-top: 1rem;"
                        :key="index"
                      >
                    ...
                    <div @click="chooseUpload(item.name)" v-if="item[item.name + 'Value2'].length == 0">
                      ...
                      >
                        <div style="padding-left: 0.5rem; padding-top: 0.5rem;">
                          <img
                            style="width: 20.031rem; height: 10.625rem;"
                            src="https://www.yunzmall.com/min_img/azfw_imgsend@2x.png"
                            class="avatar"
                          />
                        </div>
                      </van-uploader>
        ...
        <div style="width: 90%; margin: 0 auto; padding-bottom: 1.5rem;">
          ...
          <van-button color="#fe5d5a" style="height: 40px;" size="large" type="danger" v-if="status === 1"
            >已提交
          </van-button>
          <!-- 是否同意协议 -->
          <div style="display: flex; padding-top: 0.5rem;" v-if="status === 0">
            ...
            ></van-checkbox
            ><span style="margin-left: 5px;">阅读并同意</span
      ...
      <div class="conditionWrapper">
        ...
        <div class="conditionItems">
          <div class="conditionItem" v-if="team_performance_amount != null">
            <div class="img">
              <img src="https://www.yunzmall.com/min_img/collage_apply_icon_1.png" alt="" />
            </div>
            <div class="ri">
          ...
          <div class="conditionItem" v-if="direct_push != null">
            <div class="img">
              <img src="https://www.yunzmall.com/min_img/collage_apply_icon_2.png" alt="" />
            </div>
            <div class="ri">
          ...
          <template v-if="member_level.length > 0">
            <div class="conditionItem" v-for="(item, key) in member_level" :key="key" style="height: auto;">
              <div class="img" style="align-self: flex-start; height: 4.4rem; display: flex; align-items: center;">
                <img src="https://www.yunzmall.com/min_img/collage_apply_icon_3.png" alt="" />
              </div>
              <div style="flex: 1;">
                <div class="ri">
          ...
          <div class="conditionItem" v-if="goods.length > 0">
            <div class="img">
              <img src="https://www.yunzmall.com/min_img/collage_apply_icon_4.png" alt="" />
            </div>
            <div class="ri">
