<template>
	<div class="LatelyProjectItem">
		...
		<div class="leftc">
			...
			<div class="c5 cc" v-if="item.has_one_relation && item.has_one_relation.has_one_order">分红阶段：<span class="price">￥{{item.has_one_relation.has_one_order.shell_amount}}</span></div>
