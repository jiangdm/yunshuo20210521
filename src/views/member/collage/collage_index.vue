	...
	<div class="page">
		...
		<div class="headerInfo">
			<div class="infoContent">
				...
				<router-link class="rightc" :to="fun.getUrl('withdrawal')">
					<div class="icon_img">
						<img src="https://www.yunzmall.com/min_img/pd_withdrawalbg@2x.png" alt="">
					</div>
					<div class="btn_with">
						立即提现
					</div>
			...
			<div class="authentication wrapperItem">
				...
				<div class="container">
					<div class="authenItem" @click="gotoApply(item.form_id,item.id)" v-for="item in applyLevelList" :key="item.id">
						<div class="icon_img">
							<img src="https://www.yunzmall.com/min_img/pd_member_apply@2x.png" alt="">
						</div>
		...
		<div class="wrapper" v-if="examine==2">
			...
			<div class="projectManagement wrapperItem">
				...
				<div class="container">
					<div class="projectManagementItem" @click="gotoCollage(1)">
						<div class="icon_img">
							<img src="https://www.yunzmall.com/min_img/pd_order_buying@2x.png" alt="">
					...
					<div class="projectManagementItem" @click="gotoCollage(2)">
						<div class="icon_img">
							<img src="https://www.yunzmall.com/min_img/pd_order_sure@2x.png" alt="">
					...
					<div class="projectManagementItem" @click="gotoCollage(3)">
						<div class="icon_img">
							<img src="https://www.yunzmall.com/min_img/pd_order_ing@2x.png" alt="">
					...
					<div class="projectManagementItem" @click="gotoCollage(4)">
						<div class="icon_img">
							<img src="https://www.yunzmall.com/min_img/pd_order_finish@2x.png" alt="">
			...
			<div class="addProject">
				<div class="icon_img">
					<img src="https://www.yunzmall.com/min_img/pd_addproject@2x.png" alt="">
				</div>
				<div class="info">
					发布拼单项目，领取奖励
				</div>
			...
			<div class="otherItems">
				...
				<div class="otherItem" @click="gotoEchievement">
					<div class="icon_img">
						<img src="https://www.yunzmall.com/min_img/pd_level_results@2x.png" alt="">
					</div>
				...
				<div class="otherItem" @click="$router.push(fun.getUrl('collageReportform'))">
					<div class="icon_img">
						<img src="https://www.yunzmall.com/min_img/pd_income_satament@2x.png" alt="">
					</div>
				...
				<div class="otherItem" @click="$router.push(fun.getUrl('founderTeam'))" v-if="agent.has_one_level && (agent.has_one_level.is_single_spell==1 || agent.has_one_level.is_all_spell==1)" >
					<div class="icon_img">
						<img src="https://www.yunzmall.com/min_img/pd_my_team@2x.png" alt="">
					</div>
				...
				<div class="otherItem" @click="$router.push(fun.getUrl('founderSinglepool'))" v-if="agent.has_one_level && (agent.has_one_level.is_single_spell==1 || agent.has_one_level.is_all_spell==1)" >
					<div class="icon_img">
						<img src="https://www.yunzmall.com/min_img/pd_order@2x.png" alt="">
					</div>
		...
		<div class="cursor" v-if="examine==2" @click="$router.push(fun.getUrl('founderBicycle'))" >
			<img src="https://www.yunzmall.com/min_img/pd_button_bg@2x.png" alt="">
		</div>
