  ...
  <div id="teamClient">
    ...
    <div id="content">
      ...
      <div class="nav">
        <div class="nav_box">
          <ul class="nav_item">
            <li @click="changeTab(tab,i)" :class="selected === i ? 'tab-item tab' : 'tab-item'"
        ...
        <div class="list_box">
          <div class="box" v-for="(item,i) in bossList" :key='i'>
            <div v-if="item.has_one_member" class="client" @click="showDetail(item)">
              ...
              <ul class="name">
                <li><span class="star"
                          v-if="item.directly === '1'">*</span><span>客户名称：{{item.has_one_member.nickname}}</span></li>
              </ul>
...
<script>
import teamClient_controller from "./teamClient_controller";

export default teamClient_controller;
</script>
