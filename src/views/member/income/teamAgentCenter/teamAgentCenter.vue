  ...
  <div id="teamAgentCenter">
    ...
    <div class="share_holder">
      ...
      <div class="code_box">
        ...
        <router-link :to="fun.getUrl('TeamClient')" v-if="is_customer != 1">
          <div class="list1 code">
            <div class="ico extension"></div>
            {{team_agent}}
        ...
        <router-link :to="fun.getUrl('FranchiserRed')">
        ...
        <router-link :to="fun.getUrl('teamPerformance')" v-if="is_team_data != 1">
          <div class="list1 code">
            <div class="ico extension"></div>
    ...
    <div class="content">
      <van-tabs v-model="activeName">
        ...
        <van-tab name="four" v-if="extra_active">
          <span slot="title" @click="handleClick('3')">{{ teamDividendLang.extra_award || "额外奖励" }}</span>
        </van-tab>
      </van-tabs>
      <div>
              ...
              <div class="detail">
                ...
                <div class="info" v-for="(item,index2) in elem.has_many_dividend" :key='index2'>
                  ...
                  <div class="order_detail" :class="{'opens':index1==display1&&index2==display2}"
                       v-if="is_team_order_details==1||is_team_buyer==1">
                    ...
                    <div class="team_goods" id="distribution-goods" :key='i' v-for="(goods,i) in item.order_goods"
                         v-show="is_team_order_details==1">
                      <div class="img">
                        <img :src="goods.thumb">
                      </div>
                      <div class="inner">
              ...
              <div class="detail">
                ...
                <div class="info" v-for="(item,index2) in elem.has_many_dividend" :key='index2'>
                  ...
                  <div class="order_detail" :class="{'opens':index1==display1&&index2==display2}"
                    ...
                    <div class="team_goods" :key='i' id="distribution-goods" v-for="(goods,i) in item.order_goods"
                         v-show="is_team_order_details==1">
                      <div class="img">
                        <img :src="goods.thumb">
                      </div>
        ...
        <div v-show="activeName=='four'" v-if="extra_active">
          ...
          <ul class="rationList">
            <li v-for="(elem,index1) in four_content" :key='index1'>
              <div class="detail">
                <span class="month">{{ elem.create_month }}</span>
                <div class="info" v-for="(item,index2) in elem.has_many_dividend" :key='index2'>
                  <div class="info-div" @click="openDetail(index1,index2)">
                    <ul class="left">
                      <li>订单号：{{ item.order_sn }}</li>
                      <li class="time">时间：{{ item.created_at }}</li>
                    </ul>
        ...
        <ul class="rationList" v-show="activeName=='third'" v-if="prize_active">
          <template v-for="(elem,i) in third_content">
            <li :key='i' v-if="elem.level_name">
              <div class="detail">
                <div class="info">
                  <div class="left">
                    <h4>
