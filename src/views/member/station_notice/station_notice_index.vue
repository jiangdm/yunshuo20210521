<template>
  ...
  <div class="page">
    ...
    <div class="items" v-if="messageType.length!=0">
      <div class="item" v-for="(item) in messageType" :key="item.id" @click="gotoMessagePage(item.class_name)">
        <div class="face">
        ...
        <div class="wrapper">
          ...
          <div class="content">
            ...
            <div class="text" v-if="item.type_id!=1 && item.type_id!=3 && item.type_id!=6">
              ...
              <p class="c2 ca" v-for="(item2,key2) in item.msg_body" :key="key2">{{msg_body_types[item.type_id] ?
                msg_body_types[item.type_id][key2] : "未知属性:"}}{{item2}}</p>
            </div>
    ...
    <div class="empty" v-if="messageType.length==0 && weekMessage.length==0">
      <div class="img">
        <img src="https://www.yunzmall.com/min_img/massage_blankpage@3x.png" alt="">
      </div>
...
<style lang="scss" rel="stylesheet/scss" scoped>
  ...
  .tool {
    ...
    filter: drop-shadow(0 5px 18px #333);
