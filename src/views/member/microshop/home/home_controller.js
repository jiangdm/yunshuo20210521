...
export default {
  ...
  methods: {
    ...
    getMicroShop() {
      ...
      $http
        .get(
          "plugin.micro.frontend.controllers.MicroShop.default",
          {},
          "加载中"
        )
        .then(
          function(response) {
            ...
            if (response.result === 1) {
              ...
              that.$dialog.confirm({ message: "您暂时无微店,点击确定申请?"})
                .then(() => {
    ...
    setGoodsData(data) {
      let that = this;
      that.goodsListData = data.goods.data;
      that.total_page = data.goods.last_page;
      that.page = data.goods.current_page;
    ...
    getMoreData() {
      ...
      if (this.page >= this.total_page) {
        ...
        $http
          .get(
            "plugin.micro.frontend.controllers.MicroShop.default.getGoodsPage",
            {
              page: that.page
            },
            "加载中"
