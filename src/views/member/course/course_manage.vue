    ...
    <div class="box">
      <router-link :to="fun.getUrl('CourseMy')">
        <div class="list">
          <van-icon
            slot="icon"
            class="iconfont icon-member-mycourse1"
            size="1.625rem"
            color="#f15353"
            style="margin-right: 0.375rem; transform: translateY(2px);"
          ></van-icon>
          <span>我的课程</span>
      ...
      <router-link :to="fun.getUrl('CourseHistory')">
        <div class="list">
          <van-icon
            slot="icon"
            class="iconfont icon-member-history1"
            size="1.625rem"
            color="#f15353"
            style="margin-right: 0.375rem; transform: translateY(2px);"
          ></van-icon>
      ...
      <router-link :to="fun.getUrl('CourseReward')">
        <div class="list">
          <van-icon
            slot="icon"
            class="iconfont icon-member-reward2"
            size="1.625rem"
            color="#f15353"
            style="margin-right: 0.375rem; transform: translateY(2px);"
          ></van-icon>
      ...
      <router-link :to="fun.getUrl('CourseIndex', { fromHome: 1 })">
        <div class="list" id="last">
          <van-icon
            slot="icon"
            class="iconfont icon-member-course3"
            size="1.625rem"
            color="#f15353"
            style="margin-right: 0.375rem; transform: translateY(2px);"
          ></van-icon>
