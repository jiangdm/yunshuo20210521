      ...
      <ul :style="{marginLeft:-listMarginLeft+'rem' }" @touchstart="recommend_startBtn" @touchmove="recommend_moveBtn" @touchend="recommend_endBtn">
        <li :class="[i==activeIndex?'active':'']" v-for="(item,i) in recGoodList" :key="i" @click.stop="goToDetail(item.goods_id)">
          ...
          <div class="recommend_List_bottom">
            ...
            <div class="bottom">
              <div class="left"><i class="iconfont icon-home-line5"></i>讲师：{{ item.has_one_lecturer.real_name }}</div>
...
<!--            <ul>-->
<!--              <li class="lecturer">-->
<!--                讲师：{{ item.has_one_lecturer.real_name }}-->
<!--              </li>-->
<!--              -->
<!--              <li class="cost" v-if="item.vip_level_status&&item.vip_level_status.status==1">-->
<!--                {{$i18n.t('money')}} <span class="cost1">{{ item.vip_level_status.word }}</span>-->
<!--              </li>-->
<!--              <li class="cost" v-else>{{$i18n.t('money')}} {{ item.price }}</li>-->
<!--            </ul>-->
<!--          </li>-->
<!--        </div>-->
<!--        <div style="clear:both;"></div>-->
<!--        <div-->
<!--          style="width:100%;height:0.0625rem;background-color:#ebebeb;margin-top:0.625rem;transform: scaleY(.5);"-->
<!--        ></div>-->
<!--      </div>-->
...
<!--                            <li class="cost">{{$i18n.t('money')}} 199.00</li>-->
<!--                        </ul>-->
<!--                    </li>-->
<!--                </div>-->
<!--                <div style="clear:both;"></div>-->
...
<!--            </div> &ndash;&gt;-->
<!--    </div>-->
    <div class="carefully_chosen_more"  @click="moreGoods('is_hot')">
        ...
        <li v-for="(item,i) in hotGoodList" :key='i' @click="goToDetail(item.goods_id)">
          ...
          <div class="hot_bottom">
              ...
              <div class="bottom">
                ...
                <div class="right">已购买{{item.real_sales}}</div>
              </div>
          </div>
        </li>
      </ul>
    <div class="carefully_chosen_more"  @click="moreGoods('allGoods')">
              ...
              <div class="full_video_right">
                ...
                <div class="full_video_bottom">
                  <div class="leftContent">
                    ...
                    <div class="left"> 讲师：{{ item.has_one_lecturer.real_name }}</div>
                  </div>
  ...
  .recommend_List {
    ...
    ul {
      ...
      li {
        ...
        width: 10.25rem;
        box-shadow:
          0.119rem 0.147rem 0.219rem 0rem
