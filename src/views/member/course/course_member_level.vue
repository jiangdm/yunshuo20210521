            ...
            <template v-if="level_type!=2">
              <div class="wrap">
                  <div class="item" v-for="(item,index) in level_data" :key="index">
                    ...
                    <div class="al"><span v-if="level_type==0||level_type==1">订单</span><span  v-if="level_type==3">团队</span><span v-if="level_type==1">数量</span><span v-if="level_type==0">金额</span><span v-if="level_type==3">业绩</span>满
                    </div>
                    <div class="amount"><span class="num" v-if="level_type==0">{{item.order_money}}</span><span class="num" v-if="level_type==1">{{item.order_count}}</span><span class="num" v-if="level_type==3">{{item.team_performance}}</span><span v-if="level_type==1">个</span><span v-if="level_type==0||level_type==3">元</span>
                    </div>
                    <div class="yel">
                      <div class="first">您的<span v-if="level_type==0||level_type==1">订单</span><span  v-if="level_type==3">团队</span><span v-if="level_type==1">数量</span><span v-if="level_type==0">金额</span><span v-if="level_type==3">业绩</span>还差
                      </div>
                      <div class="second">
              ...
              <div class="toBuy" @click="goto">去购买</div>
            </template>
        </div>
      </div>
  </div>
