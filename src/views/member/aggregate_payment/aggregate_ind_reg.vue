    ...
    <div class="agg_content">
      <div class="agg_per_inf">
        ...
        <div class="content">
          <ul>
            <li>
              <van-field v-model="lePerName" clearable placeholder="请按照证件上的真实姓名填写" :border="false">
                <span slot="label"><i class="xin_icon iconfont icon-info-must"></i>姓名：</span>
              </van-field>
            </li>
            <li>
              <van-field v-model="lePerstatus" clearable placeholder="请按照证件上的真实号码填写" :border="false">
                <span slot="label"><i class="xin_icon iconfont icon-info-must"></i>身份证号：</span>
              </van-field>
            </li>
            <li>
              <van-field v-model="lePerphone" clearable placeholder="为方便请认真填写真实码号" :border="false">
                <span slot="label"><i class="xin_icon iconfont icon-info-must"></i>手机：</span>
              </van-field>
            </li>
            <li>
              <van-field v-model="lePerpostbox" clearable placeholder="请填写真实邮箱地址信息" :border="false">
                <span slot="label"><i class="xin_icon iconfont icon-info-must"></i>邮箱：</span>
              </van-field>
            </li>
            <li>
              <van-cell-group :border="false">
                <van-cell :border="false" is-link title-class="left-van" title-style="padding-left:20px">
                  <span slot="title">商户分类：</span>
            ...
            <li>
              <van-cell-group :border="false">
                <van-cell :border="false" is-link title-class="left-van" title-style="">
            ...
            <li>
              <van-field v-model="detaAddress" clearable placeholder="街道楼牌号等" :border="false">
                <span slot="label"><i class="xin_icon iconfont icon-info-must"></i>详细地址：</span>
              </van-field>
            </li>
            <li>
              <van-field v-model="businScope" clearable placeholder="请填写商户经营范围" :border="false">
      ...
      <div class="agg_ope_acc">
        ...
        <div class="content">
          <ul>
            <li>
              <van-field v-model="cardNumber" clearable placeholder="请填写结算银行账号或银行卡号" :border="false">
            ...
            <li>
              <div class="agg_aud_vid">
                ...
                <div class="vid_message">
                  需要上传包括：”身份证正面“、”身份证反面“、“结算银行卡“、“手持身份证”、“手持银行卡”。
                </div>
              </div>
            </li>
            <li>
              <van-field v-model="mercAbbre" clearable placeholder="请填写商户简称" :border="false">
...
<script>
import aggregate_Ind_regcontroller from './aggregate_Ind_regcontroller';
export default aggregate_Ind_regcontroller;
</script>
