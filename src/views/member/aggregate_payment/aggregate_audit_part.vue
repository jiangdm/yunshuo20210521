<template>
  <div id="aggregate">
    ...
    <van-popup v-model="show2" class="mint-popup-3" position="right" closeOnClickModal='true' modal='false'
               style="z-index: 2004;">
      <div class="city-info">
        <van-nav-bar left-arrow title="协议内容" fixed @click-left="popClose"
...
<script>
import aggregate_bank_card_setcontroller from "./aggregate_audit_partcontroller";
