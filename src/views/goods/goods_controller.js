...
// import tokerGoods from "components/goods/toker_good";
      ...
      $http.post("goods.goods.get-goods-page", json, " ").then(
        function(res) {
          if (res.result === 1) {
            ...
            if(res.data.goods_type.customer_development == 1){
              that.is_toker = true;
            }
            ...
            that.wx_video_link = res.data.pluginEnabled?(res.data.pluginEnabled.wx_video_link?res.data.pluginEnabled.wx_video_link:0):0;
