  ...
  <div id="group_detail">
    ...
    <div class="content">
      <div class="goods_list">
        <div class="goods_box">
          ...
          <ul class="goods_info">
            ...
            <li class="price">
              <span>{{$i18n.t("money")}}</span>{{popPrice}}<span style="text-decoration: line-through;">{{$i18n.t("money")}}{{info.has_one_group.max_price}}</span>
            </li>
            <li class="number">
              <div class="left">
      ...
      <div class="group_user"
        ...
        <h2>参团的人</h2>
        <div class="user_box"
             v-if="!this.fun.isTextEmpty(info.has_many_success_member)">
          <div class="user"
               v-for="(child,i) in info.has_many_success_member" :key='i'>
            <div class="img"
                 :class="{current:child.is_leader == 1}">
