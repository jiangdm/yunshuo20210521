...
export default {
  ...
  methods: {
    ...
    share(data) {
      ...
      let that = this;
      let _link,_titles,_links,_imgUrls,_descs = '';
      try {
        _link = document.location.href;
        _titles = this.fun.isTextEmpty(that.shareInfo.share_title)
          ? data.shop.shop.name
          : that.shareInfo.share_title;
        _links = this.fun.isTextEmpty(that.shareInfo.share_url)
          ? _link
          : that.shareInfo.share_url;
        _imgUrls = this.fun.isTextEmpty(that.shareInfo.share_thumb)
          ? data.shop.icon
          : that.shareInfo.share_thumb;
        _descs = this.fun.isTextEmpty(that.shareInfo.share_desc)
          ? data.shop.shop.name
