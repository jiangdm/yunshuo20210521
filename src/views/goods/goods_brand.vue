  ...
  <div id="evaluate"
    ...
    <div class="detail-box">
      <div class="logo">
        <div class="img">
          <img :src="
              brandLogo ? brandLogo : require('../../assets/images/loading.jpg')
            "
               alt="" />
        </div>
        <span>{{ brandTit }}</span>
          ...
          <div class="goods-list">
            <div class="goods"
              ...
              <ul>
                ...
                <li class="price">
                  {{$i18n.t('money')}}<b>{{ item.price }}</b><span v-show="parseInt(item.market_price)">{{$i18n.t('money')}}{{ item.market_price }}</span>
                </li>
              </ul>
            </div>
          </div>
