  ...
  <div class="page">
    ...
    <div class="answerContainer" v-if="subject!=null">
      ...
      <div class="answerList">
        <div class="answerItem" v-for="item in answerfilter" :key="item.id" @click="reward(item.id)">{{item.content}}
        </div>
      </div>
    </div>
    ...
    <van-popup v-model="successShow" style="background: transparent;" :close-on-click-overlay="false">
      <div class="successAlert">
        ...
        <div class="btn" @click="goto"><img src="https://www.yunzmall.com/min_img/videoAnswerSuccess@3x.png" alt="">
        </div>
      </div>
    </van-popup>
