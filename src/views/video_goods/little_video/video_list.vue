<template>
  <div id="video-list">
    ...
    <div class="banner" v-if="is_rotation==1">
      <van-swipe :autoplay="3000">
          <van-swipe-item v-for="(bannerItem, i) in bannerList" :key="i">
            ...
            <img class="banner-item" :src="bannerItem.img"/>
          </a>
          </van-swipe-item>
        </van-swipe>
    </div>
    ...
    <div class="cursor-box">
      <!--<img-->
        <!--src="../../../assets/images/video_more@2x.png"-->
        <!--@click="changeBtn"-->
        <!--id="imgs"-->
        <!--:class="[isOpenBtn ? 'rotateImg' : 'normalImg']"-->
      <!--/>-->
      <!--:class="[isOpenBtn ? 'active1' : '']"-->
      <!--:class="[isOpenBtn ? 'active2' : '']"-->
      <div
        class="btn btn_1"
        @click="goUrl('videoAgreement')"
      >
        <i class="iconfont icon-video_recording"></i><span class="btn-text">录制</span>
      </div>
      <div class="btn btn_2" @click="goUrl('myVideo')">
        <i class="iconfont icon-video_myvideorecord"></i><span class="btn-text">记录</span>
      </div>
    </div>
  </div>
</template>
