<template >
<div id="member_choose_bank">
	<c-title :hide="false" text='银行卡列表'></c-title>
	<div class="content">
		<div class="bank-list">
			<div class="bank" v-for="(item,index) in bank" :key="index"   :class="getIconUrl(item)" @click.stop="toPay(item)">
				<div class="top">
					<div class="avator">
...
<script>
import member_choose_bank_controller from "./member_choose_bank_controller";
export default member_choose_bank_controller;
</script>
