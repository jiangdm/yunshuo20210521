    ...
    <div class="cashier" v-if="showPage">
      ...
      <van-popup v-model="show1" position="right" :style="{ height: '100%', width: '100%', background: '#f5f5f5' }" :overlay="false">
        <div class="popup">
          <div class="text_box">
            <span>去支付</span>
            <i @click="show1 = false" class="iconfont icon-back"></i>
          </div>
          <div style="height: 40px;"></div>
          <ul class="popup_pay">
            <li>待付款金额</li>
          ...
          <div class="tbs">
            ...
            <!--<div class="right">-->
            <!--<div class="right">-->
            <!--<font color="#E84E40">{{$i18n.t('money')}}{{goods_price}}</font>-->
            <!--</div>-->
            <!--</div>-->
            <!--</div>-->
            <!-- <div class="price list"  v-if="cashier_type == 'store'">
              ...
              <div class="right">
                <div class="right">
                  <font color="#E84E40">-{{$i18n.t('money')}}{{ discount_price }}</font>
                </div>
              </div>
            </div>
            ...
            <div class="price list">
              ...
              <div class="right">
                <div class="right">
                  <font color="#E84E40">-{{$i18n.t('money')}}{{ deduction_price }}</font>
                </div>
              </div>
            </div> -->
          ...
          <div id="payBtnList">
            <div class="sureBtn" @click="submit('54')" v-if="price == '0.00'">确定</div>
            ...
            <template v-if="price > 0">
              <div class="mod_btns" v-for="(btn, i) in payType" :key="i" v-show="btn.value != 57">
                <a @click="submit(btn)" class="mod_btn">
                  <i class="iconfont" :class="getIconUrl(btn)"></i><span v-if="btn.value != 59">{{ btn.name }}{{ typename }}</span
                  ><span v-if="btn.value == 59">{{ btn.name }}</span></a
                >
                ...
                <div v-if="usdt_value == btn.value">
                  <form id="usdtubmit" method="post" :action="usdt_action">
                    <template v-for="(item, index) in usdt_form">
                      <input type="hidden" :name="index" :value="item" :key="index" />
                    </template>
                  </form>
                </div>
              </div>
