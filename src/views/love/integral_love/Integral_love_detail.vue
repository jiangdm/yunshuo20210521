<template>
  <div id="integral_love">
    ...
    <div class="tabs">
      <van-tabs v-model="activeName" @click="handleClick" :line-width="100" sticky>
        <van-tab title="全部">
          <ul class="all">
...
<script>
import Integral_love_detail_controller from "./Integral_love_detail_controller";

export default Integral_love_detail_controller;
</script>
