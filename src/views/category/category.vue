                    ...
                    <li class="info_c">
                      <template v-if="good.point_goods">
                        <span class="price" style="color: #ff9500;">
                          <small>{{ good.has_option == 1 ? ((!good.point_goods.max_point || good.point_goods.min_point == good.point_goods.max_point) ? good.point_goods.min_point : good.point_goods.min_point + "-" + good.point_goods.max_point) : good.point_goods.min_point
                        }}</small><small>{{ integral }}</small>
                        </span>
                      </template>
                      <template v-else>
