...
export default {
  ...
  methods: {
    ...
    goToAdress(lng, lat) {
      ...
      // } else {
      //   window.location.href = `https://uri.amap.com/navigation?to=${point.lng},${point.lat},${this.data_info.hotel_name}&mode=car&policy=1&src=mypage&coordinate=gaode&callnative=0`;
      // }
    },
            ...
            if (response.result === 1) {
              if(response.data.config) {
                ...
                wx.error(function(response) {
                  ...
                  window.location.href = `https://uri.amap.com/navigation?to=${point.lng},${point.lat},${that.data_info.hotel_name}&mode=car&policy=1&src=mypage&coordinate=gaode&callnative=0`;
                });
              }else {
                window.location.href = `https://uri.amap.com/navigation?to=${point.lng},${point.lat},${that.data_info.hotel_name}&mode=car&policy=1&src=mypage&coordinate=gaode&callnative=0`;
              }
