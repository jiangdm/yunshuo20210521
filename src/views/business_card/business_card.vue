  ...
  <div id="card_conter">
    ...
    <div class="card_a">
          ...
          <ul class="name">
            ...
            <li class="name_a">
              ...
              <div class="name_a_right" @click="changeLike('1')">
                <i v-if="!clickStatus.collected"
                  class="iconfont icon-bc_like_normal"
                ></i>
                <i v-if="clickStatus.collected"
      ...
      <div class="card_button">
        ...
        <button
          type="button"
          v-clipboard:copy="cardData.card_mobile"
          v-clipboard:success="onCopy"
          v-clipboard:error="onError"
          class="other"
          v-if="cardData.card_mobile"
        >
    ...
    <div class="code_box">
      ...
      <div class="code_right">
        ...
        <div class="contact_box" v-if="cardData.card_wechat"
             v-clipboard:copy="cardData.card_wechat"
             v-clipboard:success="onCopy"
             v-clipboard:error="onError">
          <div class="con_top">
            <i class="iconfont icon-card_weixin1"></i>
    ...
    <div class="my_achieve" v-if="nums.visit_statistics">
      ...
      <div class="code_box1">
        <div class="code_right2">
          ...
          <div class="contact_box3" :style="{backgroundImage:'url('+require('../../assets/images/number@2x.png')+')',backgroundRepeat:'no-repeat',backgroundPosition:'95% 100%',backgroundSize: '2.25rem 1.4rem'}">
            <div class="con_top">
              <span>累计访问次数(次)</span>
            </div>
            <div class="con_bom">
          ...
          <div class="contact_box3" v-if="nums.hasOwnProperty('all_income')" :style="{backgroundImage:'url('+require('../../assets/images/number@2x.png')+')',backgroundRepeat:'no-repeat',backgroundPosition:'95% 100%',backgroundSize: '2.25rem 1.4rem'}">
            <div class="con_top">
          ...
          <!-- 我的成就——会员 -->
          <div class="contact_box3" v-if="
          (cardType === 'member' ||
            cardType === 'team_dividend' ||
            cardType === 'commission')&&nums.hasOwnProperty('child_total')
          ...
          (cardType === 'member' ||
            cardType === 'team_dividend' ||
            cardType === 'commission')&&nums.hasOwnProperty('child_order_money')
          ...
          (cardType === 'member' ||
            cardType === 'team_dividend' ||
            cardType === 'commission')&&nums.hasOwnProperty('team_total')
          " :style="{backgroundImage:'url('+require('../../assets/images/person@2x.png')+')',backgroundRepeat:'no-repeat',backgroundPosition:'95% 100%',backgroundSize: '2.25rem 1.4rem'}">
            <div class="con_top">
              <span>客户总数量</span>
            </div>
          ...
          (cardType === 'member' ||
            cardType === 'team_dividend' ||
            cardType === 'commission')&&nums.hasOwnProperty('team_order_money')
          " :style="{backgroundImage:'url('+require('../../assets/images/money@2x.png')+')',backgroundRepeat:'no-repeat',backgroundPosition:'95% 100%',backgroundSize: '2.25rem 1.4rem'}">
            <div class="con_top">
              <span>客户总订单金额</span>
            </div>
          ...
          <!-- 我的成就——招商员 -->
          <div class="contact_box3" v-if="
          (cardType === 'staff' || cardType === 'center') && nums.hasOwnProperty('count')
          " :style="{backgroundImage:'url('+require('../../assets/images/person@2x.png')+')',backgroundRepeat:'no-repeat',backgroundPosition:'95% 100%',backgroundSize: '2.25rem 1.4rem'}">
            <div class="con_top">
              <span>招募商家数</span>
            </div>
          ...
          <div class="contact_box3" v-if="
          (cardType === 'staff' || cardType === 'center') && nums.hasOwnProperty('amount')
          " :style="{backgroundImage:'url('+require('../../assets/images/money@2x.png')+')',backgroundRepeat:'no-repeat',backgroundPosition:'95% 100%',backgroundSize: '2.25rem 1.4rem'}">
            <div class="con_top">
              <span>招募商家订单总额</span>
            </div>
          ...
          <!-- 我的成就——区域代理 -->
          <div class="contact_box3" v-if="
          (cardType === 'area_dividend') && nums.hasOwnProperty('count')
          ...
          <div class="contact_box3" v-if="
          (cardType === 'area_dividend') && nums.hasOwnProperty('amount')
          " :style="{backgroundImage:'url('+require('../../assets/images/money@2x.png')+')',backgroundRepeat:'no-repeat',backgroundPosition:'95% 100%',backgroundSize: '2.25rem 1.4rem'}">
            <div class="con_top">
              <span>区域订单总额</span>
            </div>
          ...
          <!-- 我的成就——供应商 -->
          <div class="contact_box3" v-if="
          (cardType === 'supplier') && nums.hasOwnProperty('count')
          " :style="{backgroundImage:'url('+require('../../assets/images/order@2x.png')+')',backgroundRepeat:'no-repeat',backgroundPosition:'95% 100%',backgroundSize: '2.25rem 1.4rem'}">
            <div class="con_top">
              <span>供应商订单数</span>
            </div>
          ...
          <div class="contact_box3" v-if="
          (cardType === 'supplier') && nums.hasOwnProperty('amount')
          " :style="{backgroundImage:'url('+require('../../assets/images/money@2x.png')+')',backgroundRepeat:'no-repeat',backgroundPosition:'95% 100%',backgroundSize: '2.25rem 1.4rem'}">
            <div class="con_top">
              <span>供应商订单总额</span>
            </div>
          ...
          <!-- 我的成就——店长 -->
          <div class="contact_box3" v-if="
          (cardType === 'shop_owner' || cardType === 'clerk') && nums.hasOwnProperty('count')
          " :style="{backgroundImage:'url('+require('../../assets/images/order@2x.png')+')',backgroundRepeat:'no-repeat',backgroundPosition:'95% 100%',backgroundSize: '2.25rem 1.4rem'}">
            <div class="con_top">
              <span>门店订单数</span>
            </div>
          ...
          <div class="contact_box3" v-if="
          (cardType === 'shop_owner' || cardType === 'clerk') && nums.hasOwnProperty('amount')
          " :style="{backgroundImage:'url('+require('../../assets/images/money@2x.png')+')',backgroundRepeat:'no-repeat',backgroundPosition:'95% 100%',backgroundSize: '2.25rem 1.4rem'}">
            <div class="con_top">
              <span>门店订单总额</span>
            </div>
    ...
    <!-- 推荐商家 -->
    <div
      class="recommend_seller"
      v-if="cardType === 'staff' || cardType === 'center'">
      <div class="title">
        <div class="block"></div>
        <span>我推荐的商家</span>
      </div>
      <div class="apply_list">
        <div class="apply_box" @click="toPage('supplier')" v-if="member.is_supplier == 1">
          <i
            class="iconfont icon-card_apply_a"
          ></i>
        ...
        <div class="apply_box" @click="toPage('storeApply')" v-if="member.is_store == 1">
          <i
            class="iconfont icon-card_apply_b"
          ></i>
        ...
        <div class="apply_box" @click="toPage('hotelApply')" v-if="member.is_hotel == 1">
          <i
            class="iconfont icon-card_apply_c"
          ></i>
          <ul class="apply">
      ...
      <div class="goods_list">
        <div class="goods_box" v-for="(item,i) in store_good" :key='i' @click="toGood(item)">
          ...
          <ul class="goods_text">
            ...
            <li class="price">
              <span class="price_a"><font>{{$i18n.t('money')}}</font>{{ item.price }}</span>
    ...
    <div
      class="my_store"
      v-if="cardType === 'shop_owner' || cardType === 'clerk'">
      <div class="title">
        <div class="block"></div>
        <span>我的门店</span>
      </div>
        ...
        <div class="header_box">
          ...
          <ul class="name">
            <li class="name_l1">
              ...
              <div class="name_time"  v-if="shop_owner.business_hours_start">
        ...
        <div id="coupon_box">
          <div class="coupon_bg_box">
            <div class="coupon_bg" v-for="(item,index) in coupon_list" :key='index'
                 @click="selectedcoupon(item,index)" >
              <ul class="coupon_info">
                ...
                <li class="info_bottom">
                  ...
                  <div style="background: #ccc;" class="receive"
                       v-if="item.received === 3">已抢光</div>
                  <div style="background: #ccc;"  class="receive"
                       v-if="item.received === 2">已领取</div>
                  <div style="background: #ff9102;"  class="receive"
                       v-if="item.received !== 2 && item.received !== 3">立即领取</div>
                </li>
                <!-- <li>{{item.name}}</li>
                <li>
                  <span v-if="item.coupon_method===1">{{$i18n.t('money')}}</span><font v-if="item.coupon_method===1">{{item.deduct}}</font>
      ...
      <div class="goods_list">
        <div class="goods_box" v-for="(item,i) in goods" :key='i' @click="toGood(item)">
          ...
          <ul class="goods_text">
            ...
            <li class="price">
              <font>{{$i18n.t('money')}}<span class="price_a">{{ item.price }}</span></font>
              <div class="price_b">
    ...
    <van-popup v-model="show1" position="center" round style="width: 80%;">
      <div class="reward_bg">
        <ul class="reward_text">
          ...
          <li class="number" v-if="award && award.point">{{award.point}}<span>{{custom_name.point_name}}</span></li>
          <li class="number" v-if="award && award.love">{{award.love}}<span>{{custom_name.love_name}}</span></li>
        </ul>
