          ...
          <div id="home">
            ...
            <div id="goods-image"
              ...
              <div class="top">
                ...
                <ul class="right">
                  <li @click="gotoAdvs(home_default.advs[1].link)">
                    <img :src="
                        home_default.advs[1]
                  ...
                  <li @click="gotoAdvs(home_default.advs[2].link)">
                    <img :src="
                        home_default.advs[2]
              ...
              <div class="bottom_img">
                ...
                <ul>
                  <li @click="gotoAdvs(home_default.advs[3].link)">
                    <img :src="
                        home_default.advs[3]
                  ...
                  <li @click="gotoAdvs(home_default.advs[4].link)">
                    <img :src="
                        home_default.advs[4]
                  ...
                  <li @click="gotoAdvs(home_default.advs[5].link)">
                    <img :src="
                        home_default.advs[5]
                  ...
                  <li @click="gotoAdvs(home_default.advs[6].link)">
                    <img :src="
                        home_default.advs[6]
            ...
            <div id="brand-box"
              ...
              <ul>
                <li v-for="(item, i) in home_default.brand"
                    :key="i"
              ...
              <div class="title-box">
                <ul>
                  <li class="main-title">
                    ...
                    <h2>{{ $i18n.t("home.限时优惠") }}</h2>
                  </li>
                  <li class="vice-title">{{ $i18n.t("home.用最低价格买好物") }}</li>
                </ul>
              </div>
              <div class="goods-box">
                <div class="goods"
                  ...
                  <ul>
                    ...
                    <li class="price">
                      ...
                      <font><span
                        v-show="parseInt(item.market_price)">{{ $i18n.t("money") }}{{ item.market_price }}</span></font>
                    </li>
                    <li class="time">
                      <i class="iconfont icon-member-time"
                         style="font-size: 1.625rem; color: #f96587;"></i>
              ...
              <div class="title-box">
                <ul>
                  <li class="main-title">
                    ...
                    <h2>{{ $i18n.t("home.人气推荐") }}</h2>
                  </li>
                  <li class="vice-title">{{ $i18n.t("home.精选最适合您的商品") }}</li>
                </ul>
              </div>
