<!-- 新抽奖活动 -->
<template>
  <div id="new_draw" :style="{ backgroundImage: 'url(' + 'https://www.yunzmall.com/min_img/newdraw_bg.png' + ')' }">
    ...
    <div class="top-main">
      ...
      <div class="text-img">
        <img class="text-img-src" src="https://www.yunzmall.com/min_img/images/text-img.png" alt="" />
      </div>
  ...
  .main {
    ...
    .template-box {
      ...
      .template-box-title {
        ...
        font-size: 20px;
        color: #5a250d;
        background-image: url(https://www.yunzmall.com/min_img/images/nav-img.png);
