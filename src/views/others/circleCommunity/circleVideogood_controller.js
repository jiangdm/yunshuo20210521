  ...
  methods: {
    ...
    getMoreData() {
      ...
      if (this.page >= this.total_page) {
        ...
        $http.get(url, params, '加载中').then(function (response) {
    ...
    gotoRelease() {
      if (this.fun.isTextEmpty(this.chooseGoods)) {
        ...
        this.$router.replace(
          this.fun.getUrl("circlereleaseVideo", {}, { goods_id: this.chooseGoods,circle_id:this.$route.query.circle_id })
        );
      }
    },
    enterSearch(event) {
    ...
    goBack() {
      this.$router.push(
        this.fun.getUrl("circlereleaseVideo", {}, { goods_id: this.chooseGoods })
      );
    }
  },
  components: { cTitle }
