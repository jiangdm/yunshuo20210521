    ...
    <div class="tabs-wrap">
      <div class="wrap">
        ...
        <van-tabs v-model="active" @click="onClick" style="overflow-x: scroll;" class="noticeellipsis">
          <van-tab name="0" title="全部" style="overflow: visible; white-space: nowrap; text-overflow: clip;">
          </van-tab>
          <van-tab v-for="(item,index) in catgoryList" :key="index" :name="item.id" :title="item.name" style="overflow: visible; white-space: nowrap; text-overflow: clip;">
          </van-tab>
        </van-tabs>
      </div>
