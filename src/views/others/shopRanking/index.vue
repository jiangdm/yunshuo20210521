        ...
        <div class="listBox">
          <div class="shoplist" v-for="(info, ind) in item.goods_list" :key="ind" @click="goDetail(info.id)">
            <div class="shopImg">
              ...
              <div class="posimg" style="background: url('https://www.yunzmall.com/min_img/shopRanking.png');" v-if="ind == 0">{{ ind + 1 }}</div>
              <div class="posimg" style="background: url('https://www.yunzmall.com/min_img/shopRanking2.png');" v-if="ind == 1">{{ ind + 1 }}</div>
              <div class="posimg" style="background: url('https://www.yunzmall.com/min_img/shopRanking3.png');" v-if="ind == 2">{{ ind + 1 }}</div>
            </div>
      ...
      .shoplist {
        ...
        .shopImg {
          ...
          .posimg {
            ...
            top: 0;
            left: 0.28rem;
            // background: url('https://www.yunzmall.com/min_img/shopRanking.png');
