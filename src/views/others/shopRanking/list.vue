      ...
      <div class="listBox" :class="[status == '0' ? 'isfenlei' : '']">
        <div class="list" v-show="status == '1' && calsst != 'z'" v-for="(item, index) in navinfo.goods_list" :key="index" @click="goDetail(item.id)">
          <div class="left">
            ...
            <div class="posInd" style="background-image: url('https://www.yunzmall.com/min_img/shopRanking.png');" v-if="index == '0'">
              {{ index + 1 }}
            </div>
            <div class="posInd" style="background-image: url('https://www.yunzmall.com/min_img/shopRanking2.png');" v-if="index == '1'">
              {{ index + 1 }}
            </div>
            <div class="posInd" style="background-image: url('https://www.yunzmall.com/min_img/shopRanking3.png');" v-if="index == '2'">
              {{ index + 1 }}
            </div>
            <div class="posInd" style="background-image: url('https://www.yunzmall.com/min_img/shopRanking4.png');" v-if="index > 2">
              {{ index + 1 }}
            </div>
          </div>
          <div class="right">
    ...
    .list {
      ...
      .left {
        ...
        .posInd {
          ...
          height: 1.22rem;
          width: 1.06rem;
          // background-image: url('https://www.yunzmall.com/min_img/shopRanking.png');
