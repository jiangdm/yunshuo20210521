    ...
    <div class="all">
      ...
      <div class="qr">
        ...
        <div class="image-li">
          ...
          <div class="li">
            <div class="img" v-if="datas.img_mini_src">
            ...
            <div class="right">
              <div class="one">
                ...
                <div class="button">
                  ...
                  <span v-if="item.member_id == uid" @click="delComment(item.id, 'comment')">
            ...
            <div class="right">
              <div class="one">
                ...
                <div class="button">
                  ...
                  <span v-if="uid == item1.member_id" @click="delComment(item1.id, 'reply')">
                    <i class="iconfont icon-all_delete_1"></i>
                  </span>
                </div>
              </div>
