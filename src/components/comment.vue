...
<template>
  <div id="comment">
    <!-- 精选口碑 -->
    <div class="evaTop">
      <div class="evaTitle">精选口碑&nbsp;&nbsp;<i style="color: #999; font-size: 12px;"> 好评率</i><i style="color: #ed0606; font-size: 12px;"> {{score}}</i></div>
      <div class="evaTo"
           style="color: #ed0606;"
           @click="gotoCommentList()">查看全部({{total}})&nbsp;<i class="fa fa-angle-right"
