<template>
  <div class="location-search"
       :style="{ 'background-color': datas.params.bgcolor, 'border-color':datas.params.bordercolor}" id="menu">
    <div class="location" :style="{ 'color': datas.params.color2}" @click='tolocation'>
      <i class="fa fa-map-marker" style="margin-right: 2%;"></i>{{address || '全国'}}<i class="fa fa-chevron-down"
                                                                            style="margin-left: 2%;"></i>
    </div>
    <div @click='tosearch' class="search-form-box"
         :style="{'background-color':datas.params.bgcolor,'color':datas.params.color}">
