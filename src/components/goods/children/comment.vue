...
<template>
  <div id="comment">
    <!-- 精选口碑 -->
    <div class="evaTop">
      <div class="evaTitle">精选口碑&nbsp;&nbsp;<i style="color: #999;"> 好评率</i><i style="color: #ed0606;">{{rate}}</i>
      </div>
      <div class="evaTo"
           style="color: #ed0606;"
           @click="gotoCommentList()">查看全部({{tatal}})&nbsp;<i class="fa fa-angle-right"
...
<script>
export default {
  props: ["commentInfo", "goods_id", "isCup", "rate", "tatal"],
  data() {
    return {};
  },
  methods: {
