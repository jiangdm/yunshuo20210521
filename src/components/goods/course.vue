        ...
        <div class="box-con set-pc-style" v-if="is_vshow" style="width: 100%;">
          ...
          <div v-if="isVideo && !isVoice" style="position: relative; width: 100%; height: 12.5rem;">
            ...
            <div
              ...
              v-if="isVideoOn && fun.getPhoneEnv() != 2"
            >
              <!--getPhoneEnv() 安卓为2-->
                  ...
                  >
                    ...
                    <ul class="course_catalogue_list">
                      <li
                        ...
                        :key="index"
                        @click="divPermission(item.id, index, item.course_id, item.is_audition, digListindex)"
                      >
          ...
          <div style="margin-left: 2.5%; margin-right: 2.5%; margin-top: 0.625rem; display: flex;">
            ...
            <div style="flex: 5; margin-left: 0.3125rem;">
              <div style="width: 100%; float: left;">
                <span
                  style="margin-top: 0.375rem; width: 100%; display: block; word-wrap: break-word; overflow: hidden;"
                  >{{ item.title }}</span
                >
              </div>
      ...
      <div class="box05">
        <div class="my" @click="toMyCourse">
          <van-icon
            ...
            size="1.125rem"
            color="#f7ba2a"
            style="display: block; margin: 0.3125rem 0;"
          ></van-icon>
          我的
        </div>
        <div class="kefu">
...
"
    ...
    <van-popup v-model="questionnaire_is_open" position="center" style="background: transparent;">
      <div class="surveyBox">
        <div >
          <!-- <img style="width: 18.2188rem;" src="https://www.yunzmall.com/min_img/wj_popupbg@2x.png" ></img> -->
          <img src="https://www.yunzmall.com/min_img/wj_popupbg@2x.png" style="width: 18.2188rem;" alt="">
        </div>
        <div class="centen">
          <span>{{shopName}}</span>
          <span>请您填写有奖问卷</span>
          <span>参与问卷调查，获得积分奖励!</span>
          <div class="btn">
