    ...
    <div class="html-box" v-if="datas.preview_color">
        ...
        <div class="header-info">
          ...
          <div class="user-info">
            <div class="user-name name-one">
              ...
              <span class="name-b" v-if="datas.show_ID">ID:{{ member_item.uid }} </span>
            </div>
      ...
      <div class="header-two-left" v-if="datas.style_align == 'left' && datas.choose_style == 'two'">
        <div class="header-info">
          ...
          <div class="user-info">
            <div class="user-name">
              <div class="name-a nickname" style="max-width: 11.5rem; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">{{ member_item.nickname }}</div>
              <div class="name-b" v-if="datas.show_ID">ID:{{ member_item.uid }}</div>
            </div>
            <div class="name_invite" v-if="member_item.is_agent && member_item.inviteCode && member_item.inviteCode.status">
              <div class="name-a">邀请码：{{ member_item.inviteCode.code }}</div>
      ...
      <div class="header-two-center" v-if="datas.style_align == 'center' && datas.choose_style == 'two'">
        <div class="header-info">
          ...
          <div class="user-name">
            <div class="name-a nickname" style="max-width: 15rem; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">{{ member_item.nickname }}</div>
            <div class="name-b" v-if="datas.show_ID">ID:{{ member_item.uid }}</div>
          </div>
          <div class="name_invite" v-if="member_item.is_agent && member_item.inviteCode && member_item.inviteCode.status">
            <div class="name-a">邀请码：{{ member_item.inviteCode.code }}</div>
      ...
      <div class="header-three-left" v-if="datas.style_align == 'left' && datas.choose_style == 'three'">
        <div class="header-info">
          ...
          <div class="user-info">
            <div class="user-name">
              <div class="name-a nickname" style="max-width: 6rem; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">{{ member_item.nickname }}</div>
              <div class="name-b" v-if="datas.show_ID">ID:{{ member_item.uid }}</div>
            </div>
            <div class="name_invite" v-if="member_item.is_agent && member_item.inviteCode && member_item.inviteCode.status">
              <div class="name-a">邀请码：{{ member_item.inviteCode.code }}</div>
      ...
      >
        <div class="header-info">
          ...
          <div class="user-info">
            <div class="user-name">
              <div class="name-a nickname" style="width: 9rem; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">{{ member_item.nickname }}</div>
            ...
            <div class="name_invite">
              <div class="name-c" v-if="datas.show_ID">ID：{{ member_item.uid }}</div>
              <div class="name-a" v-if="member_item.is_agent && member_item.inviteCode && member_item.inviteCode.status">邀请码：{{ member_item.inviteCode.code }}</div>
      ...
      >
        <div class="header-info">
          ...
          <div class="user-name nickname" style="display: block; max-width: 20rem; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">{{ member_item.nickname }}</div>
          <div class="name_invite">
            <div class="name-c" v-if="datas.show_ID">ID：{{ member_item.uid }}</div>
            <div class="name-a" v-if="member_item.is_agent && member_item.inviteCode && member_item.inviteCode.status">邀请码：{{ member_item.inviteCode.code }}</div>
            <div class="copybtn" v-if="member_item.is_agent && member_item.inviteCode && member_item.inviteCode.status" v-clipboard:copy="member_item.inviteCode.code"
