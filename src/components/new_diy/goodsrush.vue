  ...
  <div :class="className" :style="{'backgroundColor':datas.preview_color}">
    ...
    <div class="u_goodslist" v-if="datas.preview_color">
      ...
      <div class="u_goodslist_two" v-if="datas.sort_style.choose_icon == 1">
        ...
        <div class="u_goodslist_two_child big u_goodslist_two_child_only" v-for="(item, index) in datas.list" :key="index" v-if="item && item.stock_status === 0 || datas.disable_good != 0" @click.stop.prevent="gotoDetail(item)">
      ...
      <div class="u_goodslist_three" v-if="datas.sort_style.choose_icon == 2">
        ...
        <!-- 双排样式 -->
        <div class="u_goodslist_three_child " v-for="(item, index) in datas.list" :key="index" v-if="item && item.stock_status === 0 || datas.disable_good != 0" @click.stop.prevent="gotoDetail(item)">
          <div class="Failure" v-if="datas.disable_good != 0 && item.stock_status && item.stock_status != 0" :class="[datas.disable_good == 1?'failure_cover':'']">
            <div v-if="item.stock_status==1" class="Failure_text">{{$i18n.t('售罄')}}</div>
            <div v-if="item.stock_status==2" class="Failure_text">{{$i18n.t('已下架')}}</div>
            <div v-if="item.stock_status==3 || item.stock_status==4" class="Failure_text">{{$i18n.t('不存在')}}</div>
      ...
      <div class="u_goodslist_one" v-if="datas.sort_style.choose_icon == 3">
        ...
        <!-- 横排样式 -->
        <div class="u_goodslist_one_child " v-for="(item, index) in datas.list" :key="index" v-if="item && item.stock_status === 0 || datas.disable_good != 0" @click.stop.prevent="gotoDetail(item)">
          <div class="Failure" v-if="datas.disable_good != 0 && item.stock_status && item.stock_status != 0" :class="[datas.disable_good == 1?'failure_cover':'']">
            <div v-if="item.stock_status==1" class="Failure_text">{{$i18n.t('售罄')}}</div>
            <div v-if="item.stock_status==2" class="Failure_text">{{$i18n.t('已下架')}}</div>
            <div v-if="item.stock_status==3 || item.stock_status==4" class="Failure_text">{{$i18n.t('不存在')}}</div>
      ...
      <div class="u_goodslist_four" v-if="datas.sort_style.choose_icon == 4">
        ...
        <!-- 三排排序样式 -->
        <div class="u_goodslist_four_child " v-for="(item, index) in datas.list" :key="index" v-if="item && item.stock_status === 0 || datas.disable_good != 0" @click.stop.prevent="gotoDetail(item)">
          <div class="Failure" v-if="datas.disable_good != 0 && item.stock_status && item.stock_status != 0" :class="[datas.disable_good == 1?'failure_cover':'']">
            <div v-if="item.stock_status==1" class="Failure_text">{{$i18n.t('售罄')}}</div>
            <div v-if="item.stock_status==2" class="Failure_text">{{$i18n.t('已下架')}}</div>
            <div v-if="item.stock_status==3 || item.stock_status==4" class="Failure_text">{{$i18n.t('不存在')}}</div>
          ...
          <div class="threeChild_b">
            ...
            <!-- <div class="Child_member_price" v-if="datas.content_list.includes('4')">会员价 500.00</div> -->
            <div class="Child_price">
              <div class="Child_now_price" :style="{width: datas.button_type == 0 || datas.button_type == 1 || datas.button_type == 2 ? '100%' : '80%', fontSize: item.vip_level_status&&item.vip_level_status.status==1 ? '12px': ''}" v-if="datas.content_list.includes('3')"><em>{{$i18n.t('money')}}</em> {{ item.vip_level_status&&item.vip_level_status.status==1?item.vip_level_status.word:item.pricenow }}</div>
              <div class="Child_now_price" v-if="!datas.content_list.includes('3')"></div>
      ...
      <div class="u_goodslist_four  u_goodslist_five" v-if="datas.sort_style.choose_icon == 5">
        ...
        <!-- 三排滑动样式 -->
        <div class="u_goodslist_four_child u_goodslist_five_child" v-for="(item, index) in datas.list" :key="index" v-if="item && item.stock_status === 0 || datas.disable_good != 0" @click.stop.prevent="gotoDetail(item)">
          <div class="Failure" v-if="datas.disable_good != 0 && item.stock_status && item.stock_status != 0" :class="[datas.disable_good == 1?'failure_cover':'']">
            <div v-if="item.stock_status==1" class="Failure_text">{{$i18n.t('售罄')}}</div>
            <div v-if="item.stock_status==2" class="Failure_text">{{$i18n.t('已下架')}}</div>
            <div v-if="item.stock_status==3 || item.stock_status==4" class="Failure_text">{{$i18n.t('不存在')}}</div>
      ...
      <div class="u_goodslist_six" v-if="datas.sort_style.choose_icon == 6">
        ...
        <!-- 一大两小 -->
        <template v-for="(item, index) in datas.list" v-if="item && item.stock_status === 0 || datas.disable_good != 0">
