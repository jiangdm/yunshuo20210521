  ...
  #memberrights {
    ...
    .tool-box {
      ...
      .icon-member_integral {
        background:
          url("../../assets/images/member/member_a(55).png") no-repeat
          center;
      ...
      .icon-member-credit01 {
        background:
          url("../../assets/images/member/member_a(44).png") no-repeat
          center;
        background-size: 28px;
        width: 100%;
        margin-bottom: 4px;
      ...
      .icon-number_assets {
        background:
          url("../../assets/images/member/member_a(69).png") no-repeat
          center;
        background-size: 28px;
        width: 100%;
        margin-bottom: 4px;
      ...
      .icon-member-exchange1 {
        background:
          url("../../assets/images/member/member_a(1).png") no-repeat
          center;
        background-size: 28px;
        width: 100%;
        margin-bottom: 4px;
      ...
      .icon-member-currency1 {
        background:
          url("../../assets/images/member/member_a(14).png") no-repeat
          center;
        background-size: 28px;
        width: 100%;
        margin-bottom: 4px;
      ...
      .icon-member-frozen1 {
        background:
          url("../../assets/images/member/member_a(7).png") no-repeat
          center;
        background-size: 28px;
        width: 100%;
        margin-bottom: 4px;
      ...
      .icon-member-extension1 {
        background:
          url("../../assets/images/member/member_a(38).png") no-repeat
          center;
        background-size: 28px;
        width: 100%;
        margin-bottom: 4px;
      ...
      .icon-member_reward_ranking {
        background:
          url("../../assets/images/member/member_a(116).png") no-repeat
          center;
        background-size: 28px;
        width: 100%;
        margin-bottom: 4px;
