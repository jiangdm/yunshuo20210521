  ...
  <div :class=className>
    ...
    <div v-if="show" class="advertising-preview" :style="{width: clientWidth+'px'}" :class="[fun.isIphoneX() ? 'iphoneXStyle' : '']">
      <ul class="weixin-menu" id="weixin-menu" :style="{width: clientWidth+'px'}">
        ...
        >
          <div class="menu-item-title" :style="{lineHeight:(tab_style.icon_set.icon_position=='top' && tab_style.text_set.text_show?'25px':'50px'),    paddingTop: tab_style.icon_set.icon_position=='top' ? '2px' :''}">
          ...
          <ul class="weixin-sub-menu" v-show="selectedMenuIndex === i && btn.sub_button && btn.sub_button.length > 0">
            ...
            >
              <div class="menu-item-title" :style="{lineHeight:(tab_style.icon_set.icon_position=='top' && tab_style.icon_set.icon_show && tab_style.text_set.text_show?'25px':'50px'),paddingTop: tab_style.icon_set.icon_position=='top' ? '2px' :''}">
...
const defaultData = {
  page_info: {"group_title":{"title":"底部导航名称","type":"text","value":"默认"},"button_item":{"title":"","type":"bottomItem","choose":"2","menu_button":[{"id":0,"text":"首页","image":"","icon":"icon-fontclass-shouye","isIcon":"1","link":"/addons/yun_shop/?#/home?i=","isMinApp":"1","gh_id":"","minApp_link":"","sub_button":[], "isDefault": true, "url": 'home'},{"id":1,"text":"分类","image":"","icon":"icon-fontclass-fenlei","isIcon":"1","link":"/addons/yun_shop/?#/category?i=","isMinApp":"1","gh_id":"","minApp_link":"","sub_button":[], "isDefault": true, "url": 'category'},{"id":2,"text":"推广","image":"","icon":"icon-fontclass-tuiguang1","isIcon":"1","link":"/addons/yun_shop/?#/member/extension?i=","isMinApp":"1","gh_id":"","minApp_link":"","sub_button":[], "isDefault": true, "url": 'extension'},{"id":3,"text":"购物车","image":"","icon":"icon-fontclass-gouwuche1","isIcon":"1","link":"/addons/yun_shop/?#/cart?i=","isMinApp":"1","gh_id":"","minApp_link":"","sub_button":[], "isDefault": true, "url": 'cart'},{"id":4,"text":"会员中心","image":"","icon":"icon-fontclass-huiyuanzhongxin","isIcon":"1","link":"/addons/yun_shop/?#/member?i=","isMinApp":"1","gh_id":"","minApp_link":"","sub_button":[], "isDefault": true, "url": 'member'}],"value":{}},"tab_style":{"title":"","type":"tab","value":{"text_set":{"text_show":true,"text_color":"#333333","text_choose_color":"#ff4949"},"icon_set":{"icon_show":true,"icon_position":"top","icon_color":"#333333","icon_choose_color":"#ff4949"},"border_set":{"border_show":false,"border_color":"#e7e7eb","border_choose_color":"#29ba9c"},"bg_set":{"bg_color":"#ffffff","bg_choose_color":"#ffffff"},"children_set":{"children_color":"#333333","children_choose_color":"#29ba9c","children_bg_color":"#ffffff"}}}}
};
...
export default {
  ...
  methods: {
    ...
    selectedMenu(i, item) {
      ...
      if (item.sub_button.length <= 0 && item.link && item.link !== window.location.href) {
        if(item.isDefault) {
    ...
    selectedSubMenu(i, item) {
      ...
      if (item.link && item.link !== window.location.href) {
        window.location.href = this.fun.changeURLArg(item.link, "mid", this.fun.getKeyByMid());
      }
    },
    //选中菜单级别
