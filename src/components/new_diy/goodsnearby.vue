          ...
          <div class="twoChild_bottom">
            ...
            <div class="Child_other">
              ...
              <div style="flex: 1; text-align: right;" v-if="datas.show_location">
                <span style="background-color: #ff2c29; padding: 1px 4px; border-radius: 5px; font-size: 14px;"
                  >{{ item.distance }}{{ item.distance_unit || item.unit }}</span
                >
              </div>
            </div>
            ...
            <div class="Child_price">
              <div class="Child_now_price" :style="{ width: datas.button_type == 0 ? '100%' : '70%' }">
                ...
                <em
                  ...
                  v-if="datas.content_list.includes('2') && item.priceold != 0 && item.priceold != item.pricenow"
        ...
        >
          ...
          <div class="threeChild_top">
            ...
            <div style="position: absolute; right: 8px; bottom: 8px;" v-if="datas.show_location">
              <span
                style="background-color: #ff2c29; color: #fff; padding: 1px 4px; border-radius: 5px; font-size: 12px;"
                >{{ item.distance }}{{ item.distance_unit || item.unit }}</span
              >
            </div>
          </div>
...
export default {
  ...
  props: ['id', 'datas', 'styles', 'lastIndex', 'index'],
  computed: {
    css() {
