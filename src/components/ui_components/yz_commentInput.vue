      ...
      <div class="replyMainComment">
        <div class="left">
          ...
          <div class="comment-imgs">
            <van-uploader ref="uploaderImgs" v-model="fileList" multiple :after-read="multipleMethod_1" :max-size="photosize" @oversize="onphotosize" @delete="ondelete" />
          </div>
        </div>
        <div class="right" @click="subMainBtn" :class="[this.fun.isTextEmpty(maincomment) && this.fun.isTextEmpty(imgList) ? 'blank-color' : '']">发送</div>
      </div>
      <div class="operate-boxs">
