...
<template>
  <div id="yz-cartList">
    <van-popup v-model="showCarList" :close-on-click-overlay="false" round position="bottom" :style="{ maxHeight: '80%', display: 'flex', flexDirection: 'column' }">
