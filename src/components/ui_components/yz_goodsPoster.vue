...
<template>
  <div>
    <van-popup class="poster-popup-class" v-model="posterShow" round @closed="closedPosterShow">
      <div id="goods-poster-main" :style="{ width: width }">
        <div
          id="goods_poster_box"
          class="yz-goods"
          v-if="isQuestOK"
        ...
        <div class="yz-goods-canvas" v-show="!fun.isTextEmpty(dataURL)">
          <img style="width: 100%; border-radius: 16px;" id="goods_poster_thecanvas" />
        </div>
        <div class="yz-goods-canvas" v-show="!fun.isTextEmpty(errorImg)">
