...
//peng 新增
const DailyDividend = r => require(["../views/others/daily_red/daily_dividend"], r);
const RedRecond = r => require(["../views/others/daily_red/red_recond"], r);
const DailyRecord = r => require(["../views/others/daily_red/daily_record"], r);
...
const routes = [
  ...
  // comment
  {
    path: "/CommentDetails/:order_id/:goods_id/:comment_id/:uid",
  ...
  {
    path: "/member/pick_up_card_reimburse/:order_id/:type",
